...
export const spaceTags: Record<SpaceKey, string[]> = {
  lounge:    ['Burnout', 'Pedagogy', 'Resource Gap', 'Achievement', 'Student Welfare', 'Policy Impact'],
...
export const mockPosts: Post[] = [
  ...
  },
  {
    ...
    space: 'lounge',
    tag: 'Resource Gap',
    title: '42 students, 28 textbooks — the math does not add up',
    body: "Our classroom has 42 students this year. We received 28 textbooks. I have been photocopying pages with my own money since October. The school director says the shipment is 'on its way' — that was three months ago. The students are sharing books in groups of three for exams. I have raised this officially twice and received no response. At what point does this become a formal claim? I am not trying to cause trouble, I just need resources to do my job.",
    school: 'Farhat Hached',
    schoolId: 's2',
    district: 'Tunis',
    anonymous: false,
  ...
  },
  {
    ...
    space: 'lounge',
    tag: 'Achievement',
    title: 'My student who could barely read in September just recited a full poem from memory',
    body: "I have to share this because I need to hold onto it on the hard days. Amine started the year barely able to decode simple sentences. His parents were worried, I was worried. We worked after school three times a week. Last Thursday, in front of the whole class, he stood up and recited an eight-stanza poem — every word — without a single prompt. The class applauded for a full minute. That boy's face. That is the entire reason I do this job. Keep going, colleagues.",
    school: 'Habib Bourguiba',
    schoolId: 's3',
    district: 'Sousse',
    anonymous: false,
  ...
  },
  {
    ...
    space: 'parents',
    tag: 'Infrastructure',
    title: 'The school bus route was changed with 24 hours notice — many parents cannot adapt',
    body: "Last Wednesday the school informed us by SMS that the bus route for Zone 3 (Oued Ezzit) was being changed effective the following morning. My husband and I both start work at 7:30. We had no time to arrange alternatives. Three parents in our group had the same problem. Three children had to miss school that day. This cannot be acceptable. The route change may be justified but a 24-hour notice for a change affecting 40+ families is completely inadequate. Can the school administration address this publicly?",
    school: 'Al Amal',
    schoolId: 's4',
    district: 'Sfax',
    anonymous: false,
  ...
  },
  {
    ...
    title: 'Directed to change student grades under administrative instruction',
    body: "On March 14th I was called into the director's office and verbally instructed to raise the final assessment grade of three specific students whose parents had 'expressed concerns to the district office'. No written instruction was given. I declined and documented the conversation. I was subsequently excluded from the faculty scheduling committee without explanation. I am filing this claim to create an official record of this event. I can provide dates, names, and notes from my personal log. I am requesting that the district office investigate this pressure.",
    school: 'Farhat Hached',
    schoolId: 's2',
    district: 'Tunis',
    anonymous: false,
  ...
  },
  {
    ...
    officialResponse: "Following review of submitted reports and a site inspection conducted on April 4th, the district engineering office has confirmed that structural reinforcement is required for Classroom 7. As an immediate measure, all classes currently assigned to Room 7 will be relocated to the prefab annexe effective Monday, April 20th, until works are assessed and completed. A full structural report will be communicated to the school administration within 10 working days. The health and safety of students and staff remains our absolute priority.",
  ...
  },
  {
    ...
    space: 'claims',
    tag: 'Harassment',
    title: 'Pattern of targeted intimidation by deputy director following union activity',
    body: "Since participating in the regional teachers' union assembly in December, I have experienced a consistent pattern of what I believe is targeted professional intimidation. This has included unannounced classroom observations not applied to other teachers, public criticism of my methods in faculty meetings, and being assigned the worst schedule slot for the next semester without consultation. I have documentation of each incident. I formally request that this claim be escalated to regional education authority level for independent review, as I do not believe an internal investigation can be impartial.",
    school: 'Ibn Khaldoun',
    schoolId: 's1',
    district: 'Sfax',
    anonymous: false,
  ...
  },
  {
    ...
    space: 'gratitude',
    tag: 'Support',
    title: 'Madame Leila Mansouri — thank you for noticing',
    body: "When my son Hamza lost his grandfather in November, he became very withdrawn. I was too deep in my own grief to notice how much he was struggling at school. It was Madame Mansouri who called me. Not to complain about his grades dropping. Not to warn us. She called to tell me she had been sitting with him at lunch, letting him talk, and that he was carrying something heavy. She had already arranged for the school counselor to check in. That phone call helped me see my own son more clearly. Teachers like you are the quiet heroes of every family going through something hard.",
    school: 'Habib Bourguiba',
    schoolId: 's3',
    district: 'Sousse',
    anonymous: false,
  ...
  },
  {
    ...
    body: "I never expected a teacher to come to school during the Eid holiday break to run a revision session for the national exam. Madame Amira Tlili did exactly that for twelve students who were at risk of failing. She brought printed exercises, her own coffee, and gave four hours of her holiday to students whose families could not afford private tutoring. Three of those twelve passed the national exam. One of them is my son. I do not have words for what this act of generosity means. The education system does not always deserve teachers like her — but our children certainly do.",
    school: 'Al Amal',
    schoolId: 's4',
    district: 'Sfax',
    anonymous: false,
